...
export default function TopSearchBar() {
  ...
  return (
    <div className="shrink-0 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur px-4 py-2">
      <div className="flex items-center gap-2.5 px-3 py-2 rounded-lg bg-slate-100 dark:bg-slate-800 focus-within:bg-white dark:focus-within:bg-slate-700 focus-within:ring-2 focus-within:ring-accent-500 transition-all">
